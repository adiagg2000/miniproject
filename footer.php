<div class="footer">
    	<div class="container">
			...
			<div class="col-md-4 col_2">
    			<h4>Features</h4>
    			<p>Free and easy profile registration</p>
				<p>Safe and secure site. 100% privacy guaranteed</p>
				<p>registered profiles are manually screened and validated to ensure they meet the norms of our site</p>
				<p>User friendly interface and features for easy partner search</p>
				<p>Customer service team to assist you in all the queries raised</p>
    		</div>
